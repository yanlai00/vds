...
from baselines.her.q_function import VFunctionRND
...
class RND:
    ...
    def get_values(self, o, ag, g, u=None):
        ...
        # values to compute
        vars = [self.V_fun[0].V_tf, self.V_fun[0].V_2_tf]
        # feed
        feed = {}
    ...
    def _create_network(self, reuse=False):
        ...
        with tf.variable_scope('o_stats_rnd'):
            self.o_stats = Normalizer(self.dimo, self.norm_eps, self.norm_clip, sess=self.sess)
        with tf.variable_scope('g_stats_rnd'):
        ...
        with tf.variable_scope("ve_0_rnd") as vs:
            v_function = VFunctionRND(batch_tf, **self.__dict__)
            vs.reuse_variables()
        ...
        n_vars = [len(self._vars("ve_0_rnd"))]
